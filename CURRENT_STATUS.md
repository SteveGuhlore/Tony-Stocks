...
V5 Scheduled Paper Watch Mode has been added on top of the swing/day-trade scanner. Watch mode repeatedly scans, saves eligible candidate snapshots, and can update snapshot follow-up outcomes. Candidate snapshots remain research records only; watch mode does not create paper trades or live trades.
...
1. Let Scheduled Watch Mode run during a supervised demo session and review snapshot dedupe/noise.
